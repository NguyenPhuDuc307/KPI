namespace KPISolution.Models.ViewModels.SuccessFactor
{
    ...
    public class SuccessFactorDetailsViewModel
    {
        ...
        /// <summary>
        /// Gets or sets the collection of result indicators associated with this success factor.
        /// </summary>
        public List<ResultIndicatorListItemViewModel> ResultIndicators { get; set; } = [];
