...
{
    [Authorize]
    public class SuccessFactorController : BaseController
    {
        ...
        public async Task<IActionResult> Details(Guid id)
        {
            try
            {
                ...
                var successFactor = await this._unitOfWork.SuccessFactors
                    ...
                    .Include(sf => sf.PerformanceIndicators)
        ...
        public async Task<IActionResult> Create(SuccessFactorCreateViewModel viewModel)
        {
            try
            {
                ...
                if (this.ModelState.IsValid)
                {
                    ...
                    this.AddSuccessAlert("Yếu tố thành công đã được tạo.");
            ...
            try
            {
                ...
                if (this.ModelState.IsValid)
                {
                    try
                    {
                        ...
                        this.AddSuccessAlert("Yếu tố thành công đã được cập nhật.");
                        return this.RedirectToPreviousPage();
                    }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            try
            {
                ...
                this.AddSuccessAlert("Yếu tố thành công đã được xóa.");
                return this.RedirectToPreviousPage();
            }
            catch (Exception ex)
            {
