    ...
    public class DepartmentController : BaseController
    {
        ...
        public async Task<IActionResult> Create(DepartmentViewModel model)
        {
            try
            {
                if (this.ModelState.IsValid)
                {
                    ...
                    this.AddSuccessAlert("Phòng ban đã được tạo thành công.");
        ...
        public async Task<IActionResult> Edit(Guid id, DepartmentViewModel model)
        {
            try
            {
                ...
                if (this.ModelState.IsValid)
                {
                    ...
                    this.AddSuccessAlert("Phòng ban đã được cập nhật thành công.");
                    return this.RedirectToPreviousPage();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            try
            {
                ...
                this.AddSuccessAlert("Phòng ban đã được xóa thành công.");
                return this.RedirectToPreviousPage();
            }
            catch (Exception ex)
            {
