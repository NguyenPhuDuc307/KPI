        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessFactorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIndicatorOwner = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculationMethod = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasurementDirection = table.Column<int>(type: "int", nullable: false),
                    PerformanceTrend = table.Column<int>(type: "int", nullable: false),
                    ResultIndicatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    DataCollectionMethod = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PerformanceIndicatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ResultIndicatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SuccessFactorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    MeasuredBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    MeasurementType = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
