...
namespace KPISolution.Models.ViewModels.SuccessFactor
{
    ...
    public class EditSuccessFactorViewModel
    {
        ...
        public string? StrategicObjective { get; init; }
        ...
        public SuccessFactorStatus Status { get; init; } = SuccessFactorStatus.NotStarted;
        ...
        public SuccessFactorCategory Category { get; init; } = SuccessFactorCategory.Other;

        /// <summary>
        /// Indicates whether this is a Critical Success Factor
        /// </summary>
        [Display(Name = "Yếu tố cốt lõi")]
        ...
        public DateTime TargetDate { get; init; } = DateTime.Today.AddYears(1);
        ...
        public List<Guid> SelectedPerformanceIndicatorIds { get; init; } = [];

        /// <summary>
        /// Currently linked Performance Indicators with relationship information
        /// </summary>
        public List<SuccessFactorIndicatorRelationshipViewModel> LinkedPerformanceIndicators { get; init; } = [];
        ...
        /// </summary>
        public SelectList AvailablePerformanceIndicators { get; init; }

        /// <summary>
        /// Dropdown items for available parent Success Factors
        /// </summary>
        public SelectList AvailableSuccessFactors { get; init; }

        /// <summary>
        /// Collection of recent progress updates for this Success Factor
        /// </summary>
        public List<SuccessFactorProgressSummaryViewModel> RecentProgressUpdates { get; init; } = [];
