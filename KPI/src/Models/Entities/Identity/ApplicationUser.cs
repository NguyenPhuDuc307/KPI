...
namespace KPISolution.Models.Entities.Identity
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        public virtual ApplicationUser? Manager { get; init; }

        /// <summary>
        /// Collection of users this user manages
        /// </summary>
        public virtual ICollection<ApplicationUser>? DirectReports { get; init; }
        ...
        public string? DashboardPreferences { get; init; }

        /// <summary>
        /// Indicators this user is responsible for
        /// </summary>
        [Display(Name = "Is Indicator Owner")]
        public bool IsIndicatorOwner { get; set; } = false;
        ...
        /// <summary>
        /// Whether this user owns KPIs specifically
        /// </summary>
